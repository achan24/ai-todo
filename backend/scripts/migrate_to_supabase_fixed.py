#!/usr/bin/env python3
"""
Enhanced script to migrate data from SQLite to Supabase PostgreSQL.
This script handles data type conversions and schema differences between SQLite and Supabase.
"""
...
for table in table_order:
    ...
    for row in rows:
        ...
        if table == 'conversations' and 'user_id' not in transformed_row:
